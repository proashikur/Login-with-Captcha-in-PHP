...
$mysqli = new mysqli('localhost','root','','captcha_login');

$ip = $_SERVER['REMOTE_ADDR']; //Localhost ip address is 127.0.0.1
...
$row  = $result->fetch_array(MYSQLI_ASSOC);// Add this parameter in php 7.4 version.
